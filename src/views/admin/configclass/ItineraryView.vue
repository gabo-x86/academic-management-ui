    ...
    <template v-slot:[`item.actions`]="{item}">
      <v-row justify="space-around">
        ...
        <v-btn variant="text" class="botones-tabla-btn" prepend-icon="mdi-eye-outline" >
          ...
          <v-btn variant="text" class="botones-tabla-btn" prepend-icon="mdi-pencil"   @click="openDialogEdit(item.id)">
            <template v-slot:prepend>
              <v-icon color="black"></v-icon>
            </template>
          Editar  
          ...
          <v-btn variant="text" class="botones-tabla-btn" prepend-icon="mdi-trash-can-outline"  @click="openDialogDelete(item.id)">
            <template v-slot:prepend>
              <v-icon color="black"></v-icon>
            </template>
            Eliminar  
